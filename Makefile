...
seq_build: sequential.cpp
	$(CC) -o sequential sequential.cpp $(CFLAGS) -DDEBUG=1 -DMAT_N=8 -DTHREADS=8

seq :  seq_build
	./sequential

pthread_pipe_build: pthread_pipe.cpp
	$(CC) -lpthread -o pthread_pipe pthread_pipe.cpp $(CFLAGS) -DDEBUG=1 -DMAT_N=8 -DTHREADS=16

pthread_pipe : pthread_pipe_build
	./pthread_pipe

pthread_build: pthread.cpp
	$(CC) -lpthread -o pthread pthread.cpp $(CFLAGS) -DDEBUG=1 -DMAT_N=8 -DTHREADS=4

pthread : pthread_build
	./pthread

mpi_build: mpi.cpp
	mpic++ -o mpi mpi.cpp -DMAT_N=4 -DDEBUG=1

mpi : mpi_build
	mpirun -np 4 ./mpi 

mpi_pipe_build: mpi_pipe.cpp
	mpic++ -o mpi_pipe mpi_pipe.cpp -DMAT_N=8 -DDEBUG=1
